...
#' @examples
#' dat <- data.frame(
#'     credits = c(NA, 1.21, 1.34, '4.0', '5.0', .1, 12, 123.5, 1111, 12.123),
#'     stringsAsFactors = FALSE
#' )
#' vc_credits(dat, 'credits')
#' vc_credits2(dat, 'credits')
vc_credits <- function(data, x, ...){
	...
	is_valid <-  stringi::stri_detect_regex(col, "^[0-9]{1,2}(\\.[0-9]{0,2})?$")# this could be tighter
